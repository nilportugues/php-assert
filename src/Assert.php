 ...
 * @method static void nullOrHasValidUploadDirectory($uploadName, $uploadDir, $message = '')
 ...
 * @method static void nullOrIsDateRange($value, $min, $max, $inclusive = false, $message = '')
 * @method static void nullOrIsBetween($value, $min, $max, $inclusive = false, $message = '')
 * @method static void nullOrIsBetweenFileSize($uploadName, $minSize, $maxSize, $format = 'B', $inclusive = false, $message = '')
 ...
 * @method static void nullOrIsImage($uploadName, $message = '')
 ...
 * @method static void nullOrIsMimeType($uploadName, array $allowedTypes, $message = '')
 ...
 * @method static void nullOrIsUploaded($uploadName, $message = '')
 ...
 * @method static void nullOrNotOverwritingExistingFile($uploadName, $uploadDir, $message = '')
...
class Assert
{
     ...
     * @return bool
     */
    private static function isDefinedMethod($method, $normalized)
    {
     ...
     * @return string
     */
    private static function resolveName($method, $normalized)
    {
     ...
     * @return bool
     */
    private static function isNullOrMethod($method, array $args)
    {
